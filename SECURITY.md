...
- DeepSeek compression sends selected sanitized tool output to the configured DeepSeek endpoint by default when `DEEPSEEK_EXTERNAL_CONTEXT_ALLOWED=true` and `CONTEXT_SAVER_TRUSTED_TOOL=true`.
