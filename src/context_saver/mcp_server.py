...
def _project_pack(task: str, project_path: str, max_files: int, max_depth: int, use_deepseek: bool) -> dict[str, Any]:
    ...
    return {
        "kind": "project",
        "trusted_tool": settings.context_saver_trusted_tool,
        "trusted_for_deepseek": settings.context_saver_trusted_tool and settings.deepseek_external_context_allowed,
...
def _doctor() -> dict[str, Any]:
    ...
    return {
        ...
        "context_saver_trusted_tool": settings.context_saver_trusted_tool,
        "trusted_for_deepseek": settings.context_saver_trusted_tool and settings.deepseek_external_context_allowed,
