...
- Treat the Context Saver tool as trusted when `CONTEXT_SAVER_TRUSTED_TOOL=true`; still exclude `.env`, keys, caches, runtime files and generated outputs.
